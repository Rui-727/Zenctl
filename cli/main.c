...
"  gpu       GPU controls (not yet implemented)\n"
"  thermal   thermal zones and cooling devices (not yet implemented)\n"
"  power     power supply, sleep states (not yet implemented)\n"
"  usb       USB devices (not yet implemented)\n"
"  bt        Bluetooth adapters (not yet implemented)\n"
"  wireless  Wi-Fi PHYs (not yet implemented)\n"
"  firmware  DMI, EFI vars, ACPI, BIOS settings (not yet implemented)\n"
"  profile   save/load named profiles (not yet implemented)\n"
